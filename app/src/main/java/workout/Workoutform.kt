...
class Workoutform : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_workoutform)
        ...
        titleTextView.text = "Full Body Stretching"
        descriptionTextView.text = "\"Full Body Stretching\" refers to a series of exercises designed to stretch and lengthen the muscles throughout the entire body. This practice aims to improve flexibility, increase range of motion, and promote overall muscle relaxation."
    ...
    private fun saveWorkoutToFirestore() {
        ...
        setWorkoutId("TkUxXNFvJW2b74s3WWZO")
