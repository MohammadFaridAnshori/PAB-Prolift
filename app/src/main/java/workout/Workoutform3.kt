...
class Workoutform3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_workoutform3)
        ...
        titleTextView.text = "Hammer Curls"
        descriptionTextView.text = "\"Hammer Curls\" refers to a series of exercises designed to stretch and lengthen the muscles throughout the entire body. This practice aims to improve flexibility, increase range of motion, and promote overall muscle relaxation."
    ...
    private fun saveWorkoutToFirestore() {
        ...
        setWorkoutId("zs2u6zrGlR5MDJzwB4nS")
        ...
        val workoutCollectionRef =
            userId?.let { firestore.collection("user").document(it).collection("workout") }
        ...
        if (workoutCollectionRef != null) {
            workoutCollectionRef
                ...
                ?.addOnFailureListener { e ->
                    Toast.makeText(this, "Failed to save workout: ${e.message}", Toast.LENGTH_SHORT)
                        .show()
                }
        }
    }
