...
class Workoutform2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_workoutform2)
        ...
        titleTextView.text = "Leg Press"
        descriptionTextView.text = "\"Leg Press\" refers to a series of exercises designed to stretch and lengthen the muscles throughout the entire body. This practice aims to improve flexibility, increase range of motion, and promote overall muscle relaxation."
    ...
    private fun saveWorkoutToFirestore() {
        ...
        setWorkoutId("sIEGcmWaBDMteAljRHoy")
